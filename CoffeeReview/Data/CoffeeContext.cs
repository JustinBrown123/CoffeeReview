    ...
    public class CoffeeContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Review>().HasData(
                ...
                new Review(2, "Quite awful in taste and overall quality mate. Do not recommend this one for a night out with the chaps"),
                new Review(3, "Good for a wee bit of a wakeup but not a particular favorite of mine"),
                new Review(4, "Absolutely splendid chaps!!"),
                new Review(5, "Golly gee, this was a wee bit AWFUL"),
                new Review(6, "I was absolutely stunned when I tried this! Will definitely be sharing with a few of my chaps"),
                new Review(7, "Oh I hate to be a damper here but gosh I hated this one, an awful aftertaste ruins an otherwise ok taste"),
                new Review(8, "I almost thought I enjoyed this one but after about half a cup and a crumpet, my tummy hurt. 10/10 would not recommend to the chaps"),
                new Review(9, "Another favorite for my chaps and I. Good for a biscuit in the morning or a crumpet at night")
                );
        }
    }   
}    
